...
#define PIR_PIN 3 // PIR sensor pin connected to ARDUINO pin 3
#define TRIG_PIN 5 // Ultrasonic sensor TRIG pin connected to ARDUINO pin 5
#define ECHO_PIN 6 // Ultrasonic sensor ECHO pin connected to ARDUINO pin 6
#define MOTOR_IN1 7 // Motor driver IN1 pin connected to ARDUINO pin 7
#define MOTOR_IN2 8 // Motor driver IN2 pin connected to ARDUINO pin 8
#define MQ7_PIN A0 // MQ-7 CO sensor analog pin connected to ARDUINO A0
